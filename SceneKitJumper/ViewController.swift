...
//  SceneKitJumper
//
//  Created by xuguangyin on 2021/2/5.
//

import UIKit
import SceneKit

let kMaxPressDuration: Double = 2
let kMaxPlatformRadius: Int = 6
let kMinPlatformRadius: Int = kMaxPlatformRadius - 4
let kGravityValue: Double = 30
